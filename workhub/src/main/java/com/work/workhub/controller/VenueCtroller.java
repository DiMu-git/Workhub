...
public class VenueCtroller {
    ...
    public BaseResult getListByTime(@RequestParam(value = "startDate")String startDate,@RequestParam(value = "endDate")String endDate,@RequestParam(value = "name")String name){

        return venulService.getListByTime(startDate,endDate,name);
    }
