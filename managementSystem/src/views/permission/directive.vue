...
import checkPermission from '@/utils/permission' // Permission judgment function
...
export default {
  ...
  data() {
    return {
      key: 1 // In order to be able to reinitialize the instruction each time the permission is switched
    }
  },
  methods: {
    checkPermission,
