      ...
      <el-form :model="searchParams" :inline="true" class="searchformContent" label-width="70px"  size="small">
        <el-row>
          <el-form-item label="收款人">
            <el-input v-model="searchParams.realName" placeholder="请输入收款人" clearable style="width:140px"></el-input>
          </el-form-item>
          ...
          <el-form-item label="销售单号">
            <el-input v-model="searchParams.saleId" placeholder="请输入销售单号" clearable style="width:286px"></el-input>
          </el-form-item>
        </el-row>
        <el-row>
          <el-form-item>
    ...
    <div class="table_container">
      <el-table
        ...
        <el-table-column prop="realName" label="销售单号" width="130px">
          <template slot-scope="scope"> {{scope.row.saleId?scope.row.saleId:'--'}}</template>
        </el-table-column>
        ...
        <el-table-column prop="payTotal" label="收款金额">
          <template slot-scope="scope"> {{scope.row.payTotal!=null?scope.row.payTotal:'--'}}</template>
        </el-table-column>
        <el-table-column prop="payUse" label="收款用途">
      ...
      <el-dialog title="详情页" :visible.sync="visible" center class="defaultDialog" :close-on-click-modal="false" :close-on-press-escape="false">
          ...
          <el-row >
						<el-col :span="24">
							<el-form-item label="销售单号" prop="saleId">
								<el-input v-model="msg.saleId" autocomplete="off" disabled placeholder="请输入销售单号"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
          <el-row >
						<el-col :span="12">
							<el-form-item label="收款人" prop="realName">
								<el-input v-model="msg.realName" autocomplete="off" placeholder="请输入收款人"></el-input>
							</el-form-item>
						</el-col>
            <el-col :span="12">
              <el-form-item label="收款日期">
                <el-date-picker type="date" placeholder="选择收款日期" v-model="msg.payDate" style="width: 100%;" clearable value-format="yyyy-MM-dd"></el-date-picker>
							</el-form-item>
						</el-col>
						<!-- <el-col :span="12">
          ...
          <el-row >
						<el-col :span="12">
							<el-form-item label="收款用途">
								<el-input v-model="msg.payUse" autocomplete="off" placeholder="请输入收款用途"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
              <el-form-item label="收款金额">
								<el-input type="number" @blur="toChinese" v-model="msg.payTotal" autocomplete="off" placeholder="请输入收款金额"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
          <el-row >
						<el-col :span="12">
							<el-form-item label="收款金额大写">
								<el-input v-model="msg.payTotalA" autocomplete="off" placeholder="请输入收款金额大写"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
              <el-form-item label="支付方式">
...
import { getList,addOrEdit,del,toChinese,check} from "api/menuReceiptList/receiptList";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        realName: [{ required: true, message: '收款人不能为空', trigger: 'blur' }],
      },
      ...
      return new Promise((resolve, reject) => {
        Promise.all([
          ...
          this.msg={
            ...
            checkContent: "",//审批说明
            payDate: this.$options.filters['dateFormat'](new Date(),'yyyy-mm-dd'),//收款日期
            remark: "",//备注
            saleId: ""//销售单号
          }
  ...
  watch: {
    $route:{
      ...
      deep: true,
      handler (to, from){
        if(this.$route.params.oper == "add"){
          this.add(this.$route.params.saleId)
          this.searchParams.saleId = this.$route.params.saleId;
        }
