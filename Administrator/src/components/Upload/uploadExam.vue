<template>
  <div class="container">
      <el-upload
        ...
        <div v-if="fileTypes.length>0" slot="tip" class="el-upload__tip">支持扩展名：{{fileTypes.join("、")}} (上传成功后自动保存)</div>
      </el-upload>
...
export default {
  ...
  methods:{
    doUploadUrl(){
      return window.origin+'/patient-care/exam/online/excel/import'
    },
    //图片个数超出提示
